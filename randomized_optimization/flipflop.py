...
plot_ro_curve_df(rhc_run_curves, "Randomized Hill Climbing", 'flipflop')
plot_ro_curve_df(ga_run_curves, "Genetic Algorithm", 'flipflop')
plot_ro_curve_df(sa_run_curves, "Simulated Annealing", 'flipflop')
plot_ro_curve_df(mimic_run_curves, "MIMIC", 'flipflop')
